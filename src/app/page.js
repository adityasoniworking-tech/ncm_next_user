...
export const metadata = {
    ...
    description: "Welcome to NuttyChocoMorsels - Gandhinagar's finest 100% eggless artisanal bakery. Shop our premium collection of handmade chocolates, brownies, cookies, and more.",
};
        ...
        <div className="home-page-wrapper">
            ...
            <div className="hero-section-premium">
                <div className="hero-content-left">
                    <h1 className="main-title">Premium <span style={{color: 'var(--primary)'}}>Bakery Delights</span></h1>
                    <p className="sub-text">Experience the taste of luxury in Gandhinagar with our 100% eggless artisanal treats. Freshly baked with premium ingredients.</p>
                    <div className="hero-actions">
                        <Link href="/menu" className="hero-btn-primary">Order Now</Link>
